      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-2 order-1 lg:order-1 flex flex-col gap-6">
              ...
              {selectedFile && !isUploading && (
                <div className="animate-in fade-in">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-base font-semibold text-gray-900">Document Ready</h3>
                  </div>
            ...
            {selectedFile && !isUploading && (
              <div ref={editorRef} className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 animate-in slide-in-from-bottom-4 fade-in duration-500">
                <div className="flex items-center justify-between mb-4 border-b border-gray-100 pb-4">
                   <h3 className="text-lg font-bold text-gray-900">Sign Document</h3>
                   <div className="flex items-center gap-2">
                      <span className="text-xs px-2 py-1 bg-green-100 text-green-700 rounded-full font-medium">Editor Active</span>
                   </div>
                </div>
                ...
                <div className="relative w-full h-[70vh] overflow-auto bg-gray-100 border border-gray-300 rounded-lg flex items-center justify-center shadow-inner">
                  <div className="text-center p-8">
                     ...
                     <h4 className="text-lg font-medium text-gray-900">PDF Editor Placeholder</h4>
                     <p className="text-gray-500 mt-2 max-w-md mx-auto text-sm">
                        Implement your <strong>PDF.js</strong> or <strong>React-PDF</strong> logic here.
                        Canvas overlay for drawing signatures goes on top of the PDF layer.
                     </p>
                  </div>
                </div>
                ...
                <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                   <label className="flex items-center gap-2 text-sm font-medium text-gray-700 cursor-pointer select-none">
                    ...
                    />
                    <span>Flatten PDF <span className="text-xs text-gray-500 font-normal">(Prevents editing)</span></span>
                  </label>
          ...
          <div className="lg:col-span-1 order-1 lg:order-2">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 sticky top-24 z-10">
                <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Sign PDF</h2>
                <p className="text-gray-600 mb-4 text-sm sm:text-base">
                  Upload a PDF document to add your digital signature easily and securely.
                </p>
                ...
                <div className="text-xs text-gray-500 pt-4 border-t border-gray-100">
                  <p>Your files are processed locally in your browser for maximum privacy.</p>
                </div>
            </div>
          </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl p-6 max-w-sm w-full text-center animate-in fade-in zoom-in duration-300">
            ...
            <p className="text-gray-600 mb-6">
               Click <button onClick={handleDownload} className="text-blue-600 font-semibold hover:underline">Download</button> to save it.
            </p>
