                ...
                <div className="mt-6">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 animate-in fade-in slide-in-from-bottom-2">
                    ...
                    <div className="relative group bg-gray-50 rounded-lg border border-gray-200 p-2 hover:border-blue-300 transition-colors">
                      ...
                      <p
                        className="text-xs text-gray-900 truncate font-medium mb-1"
                    ...
                    <label className="aspect-square border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-blue-500 hover:bg-blue-50/30 transition-colors flex flex-col items-center justify-center p-3 group">
                      <svg
                        className="w-8 h-8 text-gray-400 group-hover:text-blue-500 mb-1 transition-colors"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
                      ...
                      <span className="text-xs text-gray-600 group-hover:text-blue-600 font-medium text-center transition-colors">
                        Change File
                      </span>
                      <input
                        type="file"
          ...
          <div className="lg:col-span-1 order-1 lg:order-2">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 sticky top-24 z-10">
              ...
              <p className="text-gray-600 mb-4 sm:mb-6 text-sm sm:text-base">
                Separate a PDF file into multiple documents based on pages you
                choose.
              </p>
                  ...
                  <div className="bg-gray-50 rounded-lg p-3 border border-gray-200 text-sm">
                    ...
                    {splitMode === 'even-odd' && (
                      <p className="text-gray-600">
                        This will create two files: one with all even pages and
                        one with all odd pages.
                      </p>
                    )}

                    {splitMode === 'all' && (
                      <p className="text-gray-600">
                        Every single page in the PDF will be saved as a separate
                        PDF file.
                      </p>
                    )}
                    ...
                    {splitMode === 'visual' && (
                      <p className="text-gray-600">
                        Visual selection mode allows you to click and select
                        pages from the preview on the left.
                      </p>
                    )}

                    {splitMode === 'bookmarks' && (
                      <p className="text-gray-600">
                        The PDF will be split based on the table of contents
                        (bookmarks) embedded in the file.
                      </p>
                    )}
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          <input
                            ...
                            value={nTimesInput}
                            onChange={(e) =>
                              setNTimesInput(Number(e.target.value))
                            }
                        ...
                        <p className="mt-1 text-xs text-gray-500">
                          Example: Split into files of {nTimesInput} pages each.
                        </p>
                      </div>
                    )}
                  </div>
      ...
      {showErrorModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full text-center animate-in fade-in zoom-in duration-300">
            ...
            <p className="text-gray-600 mb-6">
              Unable to split the PDF. Please try again.
            </p>
