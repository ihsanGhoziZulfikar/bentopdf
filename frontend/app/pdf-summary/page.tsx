    ...
    <div className="min-h-screen bg-gray-900 text-gray-200 antialiased font-sans flex flex-col">
      ...
      <div className="flex-grow flex items-center justify-center p-4 bg-gray-900">
        <div className="bg-gray-800 rounded-xl shadow-xl p-8 max-w-2xl w-full text-gray-200 border border-gray-700">
          ...
          <h1 className="text-2xl font-bold text-white mb-1">Summarize PDF</h1>
          <p className="text-gray-400 mb-8">
            Summarize your PDF using Large Language Model
          </p>
          ...
          <div className="space-y-6">
            ...
            {file && (
              <div className="bg-[#374151] p-4 rounded-lg flex items-center justify-between">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#374151] border-none text-white text-base rounded-lg focus:ring-2 focus:ring-indigo-500 block p-3.5 placeholder-gray-400 shadow-sm"
                  placeholder="50"
                />
              </div>
              <div>
