  ...
  return (
          ...
          <div className="flex justify-between items-center h-16">
            ...
            >
              ...
              <span className="text-white font-bold text-xl ml-2">
                <a href="/index">BentoPDF</a>
              </span>
            </div>
            {/* Desktop Navigation */}
            <div className="hidden md:flex items-center space-x-8">
              <a href="/index" className="nav-link" data-i18n="nav.home">
                Home
              </a>
              <a href="/about" className="nav-link" data-i18n="nav.about">
                About
              </a>
              <a href="/contact" className="nav-link" data-i18n="nav.contact">
                Contact
              </a>
              <a
                href="/licensing"
    ...
    "
              ...
              <button
                ...
                aria-expanded="false"
              >
                <span className="sr-only" data-i18n="nav.openMainMenu">
                  Open main menu
                </span>
                {/* Hamburger Icon */}
                <svg
        ...
        <div
          id="mobile-menu"
          className="hidden md:hidden bg-gray-800 border-t border-gray-700"
        >
          <div className="px-2 pt-2 pb-3 space-y-1 text-center">
            <a href="index" className="mobile-nav-link" data-i18n="nav.home">
              Home
            </a>
      ...
      <div id="app" className="min-h-screen container mx-auto p-4 md:p-8">
        <section id="hero-section" className="text-center py-20 relative">
          <div className="bg-grid-pattern" />
          <h1 className="text-4xl md:text-7xl font-bold text-white mb-4">
            <span data-i18n="hero.title">The</span>{' '}
            <span className="inline-flex items-center gap-3 border-2 border-indigo-400 bg-indigo-900 text-indigo-300 px-4 py-2 rounded-full mx-2 align-middle">
              <span data-i18n="hero.pdfToolkit">PDF Toolkit</span>{' '}
              <Briefcase className="w-8 h-8 md:w-12 md:h-12 transform -rotate-4" />{' '}
            </span>{' '}
            <span data-i18n="hero.builtForPrivacy">built for privacy</span>
            <span className="text-4xl md:text-6xl text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 to-purple-500">
              .
            </span>
          </h1>
          {/* <p class="text-lg text-gray-400 mb-12">Fast, Secure and Forever Free.</p> */}
          <div className="flex flex-wrap justify-center items-center gap-2 sm:gap-4 mb-12 mt-12">
            <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-gray-800/40 border border-gray-700/50 text-gray-400 text-sm font-medium">
              <CheckCircle className="w-4 h-4 text-gray-400" />
              <span data-i18n="hero.noSignups">No Signup</span>
            </span>
            <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-gray-800/40 border border-gray-700/50 text-gray-400 text-sm font-medium">
              <CheckCircle className="w-4 h-4 text-gray-400" />
        ...
        <section className="py-10 hide-section">
          <div className="container mx-auto px-4">
            <p
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12 opacity-70 grayscale hover:grayscale-0 transition-all duration-500">
              {/* Google */}
              <svg
                className="h-6 md:h-8 w-auto text-gray-400 hover:text-white transition-colors"
                viewBox="0 0 24 24"
                fill="currentColor"
                xmlns="http://www.w3.org/2000/svg"
              >
              ...
              {/* Apple */}
              <svg
                className="h-6 md:h-8 w-auto text-gray-400 hover:text-white transition-colors -ml-3"
                viewBox="0 0 24 24"
                fill="currentColor"
                xmlns="http://www.w3.org/2000/svg"
              >
        ...
        <section id="features-section" className="py-20">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-white mb-12">
            <span data-i18n="features.title" />{' '}
            <span className="marker-slanted" data-i18n="features.bentoPdf">
              BentoPDF?
            </span>
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-800 p-6 rounded-lg">
              <div className="flex items-center gap-4 mb-3">
                <UserPlus className="w-10 h-10 text-indigo-400 flex-shrink-0" />
                <h3
            ...
            <div className="bg-gray-800 p-6 rounded-lg">
              <div className="flex items-center gap-4 mb-3">
                <BadgeDollarSign className="w-10 h-10 text-indigo-400 flex-shrink-0" />
                <h3
                  className="text-xl font-bold text-white"
            ...
            <div className="bg-gray-800 p-6 rounded-lg">
              <div className="flex items-center gap-4 mb-3">
                <Infinity className="w-10 h-10 text-indigo-400 flex-shrink-0" />
                <h3
                  className="text-xl font-bold text-white"
            ...
            <div className="bg-gray-800 p-6 rounded-lg">
              <div className="flex items-center gap-4 mb-3">
                <Layers className="w-10 h-10 text-indigo-400 flex-shrink-0" />
                <h3
                  className="text-xl font-bold text-white"
            ...
            <div className="bg-gray-800 p-6 rounded-lg">
              <div className="flex items-center gap-4 mb-3">
                <Zap className="w-10 h-10 text-indigo-400 flex-shrink-0" />
                <h3
                  className="text-xl font-bold text-white"
          ...
          <div className="mb-8 max-w-lg mx-auto">
            <div className="relative">
              <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                <i data-lucide="search" className="w-5 h-5 text-gray-400" />
              </span>
              <input
                type="text"
                id="search-bar"
              ...
              <span className="absolute inset-y-0 right-0 flex items-center rounded-lg pr-2 gap-2">
                <kbd
                  id="shortcut"
                  className="bg-gray-800 px-2.5 py-1.5 rounded-md text-xs font-semibold text-gray-300 border border-gray-700 shadow-sm"
                />
                <button
                  id="open-shortcuts-btn"
                  className="p-1 hover:bg-gray-600 rounded-md text-gray-400 hover:text-white transition-colors"
                ...
                {category.tools.map((tool) => {
                  ...
                  return (
                    <Link key={tool.name} href={tool.href}>
                      <div className="border border-gray-600 p-4 rounded flex gap-3 hover:bg-gray-800">
        ...
        <div
          id="tool-interface"
          className="hidden w-full max-w-4xl mx-auto bg-gray-800 rounded-xl shadow-2xl p-6 md:p-8 border border-gray-700"
        >
          <button
            id="back-to-grid"
            className="flex items-center gap-2 text-indigo-400 hover:text-indigo-300 mb-6 font-semibold"
          >
            <i data-lucide="arrow-left" className="cursor-pointer" />
            <span className="cursor-pointer" data-i18n="tools.backToTools">
              {' '}
              Back to Tools{' '}
            </span>
          </button>
        ...
        <div
          id="alert-modal"
          className="hidden fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4"
        >
          <div className="bg-gray-800 max-w-sm w-full p-6 rounded-lg border border-gray-700 shadow-xl text-center">
            ...
            <p
              id="alert-message"
              className="text-gray-300 mb-6 whitespace-pre-line"
            >
        ...
        <div
          id="preview-modal"
          className="hidden fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-40 p-4"
        >
          <div className="bg-white text-black rounded-lg shadow-xl w-full max-w-4xl h-[90vh] flex flex-col">
            <div className="p-4 border-b flex justify-between items-center">
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className="btn bg-gray-600 text-white font-semibold py-2 px-6 rounded-lg hover:bg-gray-700"
                >
                  Close
                </button>
              </div>
        ...
        <div
          ...
          className="hidden fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4"
        >
          <div className="bg-gray-800 w-full max-w-2xl rounded-xl border border-gray-700 shadow-2xl flex flex-col max-h-[80vh]">
            <div className="p-6 border-b border-gray-700 flex justify-between items-center">
              <h3 className="text-xl font-bold text-white flex items-center gap-2">
                <i data-lucide="settings" className="w-6 h-6 text-indigo-400" />
                Settings
              </h3>
              <button
            ...
            <div className="flex border-b border-gray-700">
              <button
                ...
                className="flex-1 py-3 text-sm font-medium bg-indigo-600 text-white"
              >
                <i
              ...
              <button
                ...
                className="flex-1 py-3 text-sm font-medium text-gray-300 hover:text-white"
              >
                <i
                  data-lucide="sliders"
                  className="inline-block w-4 h-4 mr-1"
              ...
              <div className="flex justify-between items-center mb-6">
                <div className="relative flex-grow mr-4">
                  ...
                  <input
                    ...
                    className="w-full bg-gray-900 border border-gray-700 text-white rounded-lg pl-10 pr-4 py-2 focus:ring-indigo-500 focus:border-indigo-500"
                  />
                </div>
              </div>
              <div className="mb-4 p-3 bg-indigo-900/20 border border-indigo-500/30 rounded-lg flex items-start gap-3">
                <i
                  data-lucide="info"
                ...
                <p className="text-sm text-indigo-200">
                  ...
                  >
                    ...
                    Cmd/Ctrl+N etc.) as they may not work reliably.
                  </span>
                </p>
              </div>
              <div id="shortcuts-list" className="space-y-2">
            ...
            <div
              ...
              className="hidden p-6 overflow-y-auto flex-grow"
            >
              <h4
            ...
            <div className="p-6 border-t border-gray-700 flex justify-between items-center bg-gray-850 rounded-b-xl">
              <div id="shortcuts-tab-footer" className="flex gap-3">
                <button
                ...
                >
                  <i data-lucide="upload" className="w-4 h-4" /> Import
                </button>
                <button
                  id="export-shortcuts-btn"
                  className="text-gray-400 hover:text-white text-sm font-medium flex items-center gap-1 transition-colors"
                >
                  <i data-lucide="download" className="w-4 h-4" /> Export
                </button>
              </div>
              <div id="preferences-tab-footer" className="hidden w-full">
                <p
        ...
        <div
          id="warning-modal"
          className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 hidden items-center justify-center p-4"
        >
          <div className="bg-gray-800 rounded-xl border border-gray-700 shadow-2xl max-w-md w-full overflow-hidden animate-scale-in">
            <div className="p-6">
              <div className="flex items-start gap-4 mb-4">
                <div
                  id="warning-icon"
                  className="w-12 h-12 flex items-center justify-center rounded-full bg-yellow-500/10 flex-shrink-0"
                >
                  <i
            ...
            <div className="flex gap-3 p-4 bg-gray-850 border-t border-gray-700">
              <button
        ...
        <div className="section-divider hide-section mb-20 mt-10" />
        {/* COMPLIANCE SECTION START */}
        <section
          id="security-compliance-section"
          className="py-20 hide-section"
        >
          <div className="mb-8 text-center">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight mb-6 text-balance">
              <span data-i18n="compliance.title" />
              <span className="inline-flex items-center gap-2">
                <Shield className="w-8 h-8 md:w-10 md:h-10 text-indigo-400 bg-indigo-900 rounded-lg p-1.5" />
                <span data-i18n="compliance.weKeep">We keep</span>
              </span>
              <br className="hidden sm:block" />
              <span
                className="inline-block border-2 border-indigo-400 bg-indigo-900 text-indigo-300 px-4 py-2 rounded-full mx-2 text-2xl md:text-3xl lg:text-4xl font-bold"
          ...
          <div className="mb-16 text-center">
            <span
              className="inline-flex items-center gap-2 text-indigo-400 text-lg font-medium transition-colors"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-4">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p
                className="text-gray-400 text-sm md:text-base leading-relaxed max-w-xs"
        ...
        <div className="section-divider hide-section" />
        <section id="faq-accordion" className="space-y-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-white mb-12 mt-8">
            Frequently Asked <span className="marker-slanted">Questions</span>
          </h2>
          ...
          <FAQItem
            ...
            answer="Yes! BentoPDF works on any operating system with a modern browser."
          />
        ...
        <div className="section-divider hide-section" />
        <section id="testimonials-section" className="py-20 hide-section">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-white mb-12">
            <span data-i18n="testimonials.title">What Our</span>{' '}
            <span className="marker-slanted" data-i18n="testimonials.users">
              Users
            </span>{' '}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            <div className="testimonial-card">
              ...
              <p className="text-gray-400">
                "This is the tool I've been searching for! It's fast, free, and
                I love that my confidential documents never get uploaded to some
            ...
            <div className="testimonial-card">
              <div className="flex items-center mb-4">
                <div>
                  <p className="font-bold text-white">Mark Chen</p>
                  <div className="text-yellow-400 flex items-center text-sm">
                    ★★★★★
                  </div>
                </div>
            ...
            <div className="testimonial-card">
              <div className="flex items-center mb-4">
                <div>
                  <p className="font-bold text-white">Anonymous User A-35Z</p>
                  <div className="text-yellow-400 flex items-center text-sm">
                    ★☆☆☆☆
                  </div>
                </div>
              ...
              <p className="text-gray-400">
                "Terrible. It won't let me upload my files to the cloud. How is
                my Big Data Tech Overlord supposed to know I signed a permission
                slip for my kid's field trip? Useless for my data profile."
              </p>
            </div>
            <div className="testimonial-card">
              <div className="flex items-center mb-4">
                <div>
                  <p className="font-bold text-white">Dr. Brickson</p>
                  <div className="text-yellow-400 flex items-center text-sm">
                    ★★★★★
                  </div>
                </div>
            ...
            <div className="testimonial-card">
              <div className="flex items-center mb-4">
                <div>
                  <p className="font-bold text-white">AdTracker Pro</p>
                  <div className="text-yellow-400 flex items-center text-sm">
                    ★☆☆☆☆
                  </div>
                </div>
              ...
              <p className="text-gray-400">
                ...
                single tracker. How am I supposed to know if a product is good
                if it's not following me around the internet for a week? 1
                star."
              </p>
            </div>
            <div className="testimonial-card">
              <div className="flex items-center mb-4">
                <div>
                  <p className="font-bold text-white">Raj P.</p>
                  <div className="text-yellow-400 flex items-center text-sm">
                    ★★★★★
                  </div>
                </div>
              ...
              <p className="text-gray-400">
                "Simple, elegant, and powerful. I needed to merge 50 reports,
                and it handled it instantly without crashing my browser. This is
                what a web tool should be. Highly recommended."
              </p>
            </div>
          </div>
        </section>
        <div className="section-divider" />
        <section id="support-section" className="py-20">
          <div className="max-w-4xl mx-auto text-center bg-gray-800 p-8 md:p-12 rounded-xl border border-gray-700 shadow-2xl">
            <h2
            ...
            >
              BentoPDF is a passion project, built to provide a free, private,
              and powerful PDF toolkit for everyone. If you find it useful,
              consider supporting its development. Every coffee helps!
            </p>
            <a
              href="https://ko-fi.com/alio01"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 px-8 py-3 rounded-full bg-gradient-to-b from-indigo-500 to-indigo-600 text-white font-semibold focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-indigo-400 hover:shadow-xl hover:shadow-indigo-500/30 transition-all duration-200 transform hover:-translate-y-1 mt-5"
            >
        ...
        <div id="signature-ghost" className="hidden" />
        {/* Scroll to Top Button */}
        <button
          id="scroll-to-top-btn"
          className="fixed bottom-12 right-8 bg-indigo-600 hover:bg-indigo-700 text-white p-3 rounded-full shadow-lg transition-all duration-300 opacity-0 translate-y-10 invisible z-40"
          aria-label="Scroll to top"
        >
          <i data-lucide="arrow-up" className="w-6 h-6" />
        </button>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
            <div className="mb-8 md:mb-0">
              ...
              <p className="text-gray-400 text-sm" data-i18n="footer.copyright">
