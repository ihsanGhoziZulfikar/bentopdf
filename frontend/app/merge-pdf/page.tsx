            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              {selectedFiles.length === 0 ? (
                <div className="border-2 border-dashed border-blue-300 rounded-lg p-12 text-center bg-blue-50/30">
                  ...
                  <label className="inline-flex items-center px-6 py-3 bg-blue-50 text-blue-600 rounded-full cursor-pointer hover:bg-blue-100 transition-colors border border-blue-200">
                  ...
                  <div className="mt-6 flex items-center justify-center text-sm text-blue-600">
                ...
                <div className="space-y-4">
                    ...
                    >
                      <div className="flex items-center space-x-3 flex-1 min-w-0">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-gray-900 truncate font-medium">{file.name}</p>
                  ...
                  <label className="flex items-center justify-center w-full p-4 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-blue-500 hover:bg-blue-50/30 transition-colors">
                    <svg className="w-5 h-5 text-gray-400 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4" />
                    </svg>
                    <span className="text-gray-600 font-medium">Add more files</span>
                    <input
                      type="file"
                      multiple
                      accept="application/pdf"
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <button
                ...
                className="mx-auto py-3 px-6 bg-gray-900 text-white rounded-3xl hover:bg-gray-800 disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors flex items-center justify-center font-medium"
              >
                {isMerging ? (
                  <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center space-x-3 mb-4 md:mb-0">
              <img src="/asset/images/logo-bento.svg" alt="logo" className='w-30' />
