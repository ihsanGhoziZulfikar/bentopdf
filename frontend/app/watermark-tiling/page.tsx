        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 items-start">
                    ...
                    <div className="w-full max-w-sm animate-in fade-in zoom-in duration-300">
                       <div className="flex justify-center mb-4">
                          ...
                          <div className="relative">
                             ...
                             <div className="absolute inset-0 flex items-center justify-center font-bold text-xs text-blue-600">PDF</div>
                          </div>
                       </div>
                       <h3 className="text-gray-900 font-semibold text-lg mb-2">Uploading File...</h3>
                    ...
                    <div className="bg-white w-[80%] h-[90%] shadow-lg p-8 relative overflow-hidden flex flex-col gap-4">
                        ...
                        >
                           {Array.from({ length: 40 }).map((_, i) => (
                              ...
                              >
                                 {watermarkType === 'text' ? watermarkText : '[LOGO]'}
                              </div>
                           ))}
                        </div>
                    </div>
          ...
          <div className="lg:col-span-1 order-1 lg:order-2">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 sticky top-24 z-10">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Watermark Tiling</h2>
                ...
                <div className="space-y-5 animate-in fade-in">
                   ...
                   <div className="space-y-4 pt-2 border-t border-gray-100">
                      ...
                      <div>
                       ...
                       <div>
                         <div className="flex justify-between mb-1">
                           <label className="text-xs font-medium text-gray-700">Spacing (Gap)</label>
