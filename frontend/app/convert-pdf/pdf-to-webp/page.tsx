  ...
  const handleConvert = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      for (let i = 1; i <= pdf.numPages; i++) {
        ...
        // Scale 2.0 untuk menjaga ketajaman pada format WebP
        ...
        // Konversi ke WebP dengan quality slider
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
              <div className="border-2 border-dashed border-blue-300 rounded-lg p-6 sm:p-12 text-center bg-blue-50/30">
                ...
                <p className="text-gray-700 text-base sm:text-lg font-medium mb-2 px-2">
                  Drag and drop your PDF to convert to optimized WebP.
                </p>
                ...
                <div className="mt-4 sm:mt-6 flex items-center justify-center text-xs sm:text-sm text-blue-600 px-2">
                  Modern Format: WebP (Superior Compression)
                </div>
              </div>
          ...
          <div className="lg:col-span-1 order-1 lg:order-2">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
              ...
              <p className="text-gray-600 mb-4 sm:mb-6 text-sm sm:text-base">
                Create highly compressed images that load faster on the web.
              </p>
              ...
              <button
                ...
                className="w-full py-2.5 sm:py-3 px-4 sm:px-6 bg-gray-900 text-white rounded-3xl hover:bg-gray-800 disabled:bg-gray-300 transition-all flex items-center justify-center font-medium text-sm sm:text-base shadow-sm"
              >
                {isProcessing ? (
                  <>
                    <svg
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 text-center">
          <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full animate-in fade-in zoom-in duration-300">
            ...
            <p className="text-gray-600 mb-2">
              Your WebP files are compressed and ready.
            </p>
            <button
            ...
            <button
              onClick={handleNext}
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-full flex items-center justify-center gap-2 transition-colors"
            >
              Continue{' '}
              <svg
                className="w-5 h-5"
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 text-center">
          <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full animate-in fade-in zoom-in duration-300">
            ...
            <p className="text-gray-600 mb-6">
              We couldn't process this PDF to WebP. Please check if the file is
              corrupted.
            </p>
            <button
