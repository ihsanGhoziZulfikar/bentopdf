...
export default function PdfToTiff() {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files.length > 0) {
      ...
      // Di sini logika pemrosesan file PDF ke TIFF akan berjalan
    }
  };
      ...
      >
        <div className="bg-gray-800 rounded-xl shadow-xl px-4 py-8 md:p-8 max-w-2xl w-full text-gray-200 border border-gray-700">
          ...
          <p className="text-gray-400 mb-6">
            Convert each page of a PDF file into a TIFF image.
          </p>
          ...
          <div id="file-display-area" className="mt-4 space-y-2">
            {/* Area untuk menampilkan nama file/progress */}
          </div>

          {/* Options Panel - Button Download */}
          {/* Hanya muncul jika file sudah dipilih */}
          {fileSelected && (
