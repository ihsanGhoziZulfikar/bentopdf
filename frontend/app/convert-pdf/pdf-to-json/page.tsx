...
export default function PdfToJson() {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files.length > 0) {
      // Mengubah FileList menjadi Array dan menggabungkan dengan file yang sudah ada (jika perlu)
      ...
      <div className="min-h-screen flex items-center justify-center p-4 bg-gray-900">
        <div className="bg-gray-800 rounded-xl shadow-xl p-8 max-w-2xl w-full text-gray-200 border border-gray-700">
          ...
          <div className="upload-section mb-6">
            {/* Drop Zone */}
            <div className="relative flex flex-col items-center justify-center w-full h-48 border-2 border-dashed border-gray-600 rounded-xl cursor-pointer bg-gray-700 hover:bg-gray-600 transition-colors duration-300 group">
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                ...
                <p className="text-xs text-gray-500">Multiple PDF files</p>
            ...
            <button
              ...
              className={`w-full mt-6 py-3 px-4 font-bold rounded-lg transition-all shadow-lg ${
                files.length === 0
          ...
          {/* Status Message Container (Hidden by default logic) */}
          <div
            id="status-message"
            className="mt-4 hidden p-3 rounded-lg text-sm"
          ></div>
        </div>
      </div>
