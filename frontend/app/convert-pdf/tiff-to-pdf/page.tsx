...
import {
  ...
  Plus,
  Trash2,
  FileImage, // Icon untuk file gambar TIFF
  FileCheck,
  Layers, // TIFF seringkali multi-layer/multi-page, icon ini cocok
} from 'lucide-react';
...
export default function TiffToPdf() {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files.length > 0) {
      ...
      if (validFiles.length !== newFiles.length) {
        alert('Some files were skipped because they are not TIFF images.');
      }
  ...
  const handleConvert = () => {
    ...
    // TIFF seringkali berukuran besar, jadi kita buat simulasi loading sedikit bervariasi
    setTimeout(() => {
      setIsProcessing(false);
      alert(`Successfully converted ${files.length} TIFF file(s) to PDF!`);
    }, 2000);
  };
    ...
    <div className="min-h-screen bg-gray-900 text-gray-200 antialiased font-sans flex flex-col">
      ...
      <div className="flex-grow flex items-start justify-center py-12 p-4 bg-gray-900">
        <div className="bg-gray-800 rounded-xl shadow-xl px-4 py-8 md:p-8 max-w-2xl w-full text-gray-200 border border-gray-700">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">TIFF to PDF</h1>
          <p className="text-gray-400 mb-6">
            Convert one or more single or multi-page TIFF images into a single
            PDF file.
          </p>
          ...
          >
            <div className="flex flex-col items-center justify-center pt-5 pb-6">
              ...
              <p className="text-xs text-gray-500">TIFF images</p>
            ...
            <input
              ...
              className="hidden"
              multiple
              accept="image/tiff,.tiff,.tif" // Spesifik TIFF
                  ...
                  >
                    <div className="flex items-center gap-3 overflow-hidden">
                      <div className="bg-gray-800 p-2 rounded">
                        {/* Menggunakan Icon Layers untuk merepresentasikan kemungkinan Multi-page TIFF */}
