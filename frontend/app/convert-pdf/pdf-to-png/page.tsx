...
// import Image from 'next/image'; // Gunakan jika ada file gambar di public/images
import {
  ArrowLeft,
  UploadCloud,
  Instagram,
...
export default function PdfToPng() {
  ...
  // State untuk Scale/Resolusi (1.0 - 3.0)
  // Default di HTML adalah 2.0
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files.length > 0) {
      ...
      // Logika penyimpanan file ke state akan ada di sini
    }
  };
    ...
    <div className="min-h-screen bg-gray-900 text-gray-200 antialiased font-sans">
      ...
      >
        <div className="bg-gray-800 rounded-xl shadow-xl px-4 py-8 md:p-8 max-w-2xl w-full text-gray-200 border border-gray-700">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">PDF to PNG</h1>
          <p className="text-gray-400 mb-6">
            Convert each page of a PDF file into a high-quality PNG image with
          ...
          {/* Options Panel - Logic: Scale (1.0 - 3.0) */}
          {fileSelected && (
