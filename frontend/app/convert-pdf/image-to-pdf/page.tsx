...
export default function ImageToPdf() {
  ...
  // Ref untuk input file agar bisa dipanggil tombol lain
  ...
  // Trigger input file click via button/div
  ...
  const handleConvert = () => {
    ...
    setTimeout(() => {
      ...
      alert(
        `Converting ${files.length} images with ${quality} quality... (Logic implementation needed)`
      );
    }, 2000);
  };
    ...
    <div className="min-h-screen bg-gray-900 text-gray-200 antialiased font-sans flex flex-col">
      ...
      <div className="flex-grow flex items-start justify-center py-12 p-4 bg-gray-900">
        <div className="bg-gray-800 rounded-xl shadow-xl px-4 py-8 md:p-8 max-w-2xl w-full text-gray-200 border border-gray-700">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">Image to PDF</h1>
          <p className="text-gray-400 mb-6">
            Convert one or more images into a single PDF file. Supported
          ...
          {files.length > 0 && (
            <div className="mt-6 animate-in fade-in slide-in-from-top-4 duration-300">
              ...
              {/* SETTINGS & CONVERT */}
              <div className="bg-gray-750 rounded-lg p-4 border border-gray-700 bg-gray-800/50">
                <div className="mb-4">
                  <label
                    htmlFor="quality"
