...
import { FileText, Download, Loader2, ArrowLeft, AlignLeft } from 'lucide-react';
import Link from 'next/link';
import * as pdfjsLib from 'pdfjs-dist';
import { saveAs } from 'file-saver';

// Pastikan workerSrc sudah benar sesuai solusi sebelumnya
  ...
  const convertToText = async () => {
    ...
    try {
      ...
      for (let i = 1; i <= pdf.numPages; i++) {
        ...
        // Menggabungkan teks per halaman
      ...
      alert("Gagal mengekstrak teks. Pastikan file tidak rusak.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 text-center">
          ...
          <p className="text-gray-600 mb-8">Ekstrak semua teks dari dokumen PDF Anda menjadi file teks murni (.txt).</p>
          ...
          <div className="max-w-md mx-auto">
            <label className="flex flex-col items-center justify-center w-full h-48 border-2 border-dashed border-gray-300 rounded-2xl cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors">
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                ...
                <p className="text-xs text-gray-400">Hanya mendukung format .pdf</p>
              </div>
