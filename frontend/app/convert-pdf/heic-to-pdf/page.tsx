...
export default function HeicToPdf() {
  ...
  const handleFileChange = (e: ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files.length > 0) {
      ...
      // VALIDASI: Filter khusus HEIC/HEIF
      ...
      if (heicFiles.length !== newFiles.length) {
        setErrorMsg(
          'Some files were skipped because they are not HEIC images.'
        );
      } else {
        setErrorMsg(null);
      }
      ...
      const uploadFiles = heicFiles.map((f) => ({
        name: f.name,
        size: f.size,
        progress: 0,
      }));
  ...
  const handleConvert = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    if (selectedFiles.length === 0) {
      setErrorMsg('Please select at least 1 HEIC file to convert.');
      return;
    }
    ...
    }, 2500); // HEIC biasanya butuh waktu sedikit lebih lama untuk decode
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
              ...
              <div className="border-2 border-dashed border-blue-300 rounded-lg p-6 sm:p-12 text-center bg-blue-50/30">
                ...
                <p className="text-gray-700 text-base sm:text-lg font-medium mb-2 px-2">
                  Drag and drop your HEIC files here.
                </p>
                ...
                <div className="mt-4 sm:mt-6 flex items-center justify-center text-xs sm:text-sm text-blue-600 px-2">
                  ...
                  Supported formats: HEIC, HEIF (iPhone Photos)
                </div>
              </div>
          ...
          <div className="lg:col-span-1 order-1 lg:order-2">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
              ...
              <p className="text-gray-600 mb-4 sm:mb-6 text-sm sm:text-base">
                Convert your iPhone HEIC photos into a high-quality PDF
                document.
              </p>
      ...
      {/* Modals tetap sama tapi dengan teks yang relevan */}
      {showSuccessModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-lg w-auto text-center animate-in fade-in zoom-in duration-300">
            ...
            <p className="text-gray-600 mb-2">
              Your HEIC images have been converted to PDF.
            </p>
            <p className="text-gray-600 mb-6">
              If download doesn't start, click{' '}
              <button
      ...
      {showErrorModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full text-center animate-in fade-in zoom-in duration-300">
            ...
            <p className="text-gray-600 mb-6">
              Failed to process HEIC images. Please ensure the files are not
              corrupted.
            </p>
            <button
